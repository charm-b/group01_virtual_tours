...
const addComment = async ({ id, uid, timestamp, comment}) => {
...
const addNewPhotoWithComments = async ({uid, imageUrl, comment, timestamp, like}) => {
...
const disLikePhoto = async ({userID, photoID}) => {
